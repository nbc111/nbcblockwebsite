        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://github.com/nbc111" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-chain-highlight transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://t.me/officialnbcoin/1" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors cursor-pointer">{t('footer.communityForum')}</a></li>
              <li><a href="https://medium.com/@business_48421" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors cursor-pointer">{t('footer.contactUs')}</a></li>
            </ul>
          </div>
        </div>
